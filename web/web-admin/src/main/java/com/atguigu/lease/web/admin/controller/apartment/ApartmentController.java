...
public class ApartmentController {
    ...
    public Result saveOrUpdate(@RequestBody ApartmentSubmitVo apartmentSubmitVo) {
        service.saveOrUpdateApartSubmitVo(apartmentSubmitVo);
        return Result.ok();
    }

    @Operation(summary = "根据条件分页查询公寓列表")
    @GetMapping("pageItem")
    public Result<IPage<ApartmentItemVo>> pageItem(@RequestParam long current, @RequestParam long size, ApartmentQueryVo queryVo) {// todo
    ...
    public Result<ApartmentDetailVo> getDetailById(@RequestParam Long id) { // todo
    ...
    public Result removeById(@RequestParam Long id) { // todo
